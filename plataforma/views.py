...
def dados_paciente(request, id):
    ...
    if request.method == 'GET':
      ...
      # parei nessa parte para eu mesma fazer a validação de se ta tudo preenchido e se é tudo numero.
...
def deletar_opcao(request, opcao_id):
    opcao = Opcao.objects.get(id=opcao_id)
    opcao.delete()
    messages.add_message(request, constants.SUCCESS, 'Opcao deletada com sucesso')
    return redirect('/pacientes/')
