...
urlpatterns = [
    ...
    path('deletar-opcao/<int:opcao_id>', views.deletar_opcao, name='deletar_opcao' ),
    path('deletar-paciente/<int:paciente_id>', views.deletar_paciente, name='deletar_paciente' ),
]
